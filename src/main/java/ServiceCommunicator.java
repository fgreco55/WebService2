...
/*
 ...
 Works for typical websites (but not very useful) and works for free service calls that don't require authentication.
 Definitely not production quality (error handling isn't optimal and methods should be better.
 -fdg
 */
